...
<section class="my-5">
    <div class="hero-wrapper container">
        <img src="asset/BMW M4 GT3.jpg" alt="BMW M4 GT3" class="img-fluid hero-img">
    </div>
</section>
    ...
    <div class="row g-4" id="catalog-mobil">
        <div class="col-md-4">
            <div class="card h-100">
                <img src="asset/BMW 1.webp" class="card-img-top" alt="BMW M4">
                <div class="card-body">
                    <h5 class="card-title">BMW M4</h5>
                    <p class="card-text">
                        Offering modern looks, speed, and luxury in one premium package.
                    </p>
        ...
        <div class="col-md-4">
            <div class="card h-100">
                <img src="asset/BMW 2.webp" class="card-img-top" alt="BMW M4 Variant">
                <div class="card-body">
                    <h5 class="card-title">BMW M4 Competition</h5>
                    <p class="card-text">
                        Engineered for performance with aggressive styling and precision handling.
                    </p>
        ...
        <div class="col-md-4">
            <div class="card h-100">
                <img src="asset/BMW 3.webp" class="card-img-top" alt="BMW M4 Sport">
                <div class="card-body">
                    <h5 class="card-title">BMW M4 Sport</h5>
                    <p class="card-text">
                        A perfect balance between comfort, sport, and executive presence.
                    </p>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul id="wishlist-list" class="list-group">
                    </ul>
            </div>
        </div>
    </div>
